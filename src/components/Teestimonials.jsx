...
const Teestimonials = () => {
  return (
    <div className="relative w-full flex flex-col items-center justify-center h-[600px] overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-2 relative bg-white rounded-[17px] w-[600px] pt-[60px] pb-[30px] px-[40px] mt-[100px]">
        <img
          src={photo}
        ...
        <img
          src={left}
          alt=""
          className="absolute width-[100px] h-[100px] object-fit transform top-1/2 -translate-y-1/2 -left-[50px]"
        />
        <img
          src={right}
          alt=""
          className="absolute width-[100px] h-[100px] object-fit transform top-1/2 -translate-y-1/2 -right-[50px]"
        />
      </div>
